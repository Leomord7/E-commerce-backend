package com.backtech.easybuy.products.controller;
...
public class ProductController {
    ...
    public ResponseEntity<PagedResponse<ProductDto>> getAllProducts(
            ...
            @RequestParam(defaultValue = "12") @Min(value = 1, message = "Page size cannot be less than 1") @Max(value = 100, message = "Page size cannot be greater than 100") int size
    ) {
    ...
    public ResponseEntity<PagedResponse<ProductDto>> getAllProductByCategory
