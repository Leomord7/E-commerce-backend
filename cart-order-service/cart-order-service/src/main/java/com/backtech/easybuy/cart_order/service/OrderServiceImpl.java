...
import com.backtech.easybuy.cart_order.client.ProductClientTest;
import com.backtech.easybuy.cart_order.dto.*;
...
//import com.backtech.easybuy.cart_order.client.InventoryClient;
import com.backtech.easybuy.cart_order.entity.Cart;
import com.backtech.easybuy.cart_order.entity.CartItem;
import com.backtech.easybuy.cart_order.entity.CartStatus;
import com.backtech.easybuy.cart_order.entity.Order;
import com.backtech.easybuy.cart_order.entity.OrderItem;
import com.backtech.easybuy.cart_order.entity.OrderStatus;
import com.backtech.easybuy.cart_order.exception.BusinessRuleException;
import com.backtech.easybuy.cart_order.exception.ExternalServiceException;
import com.backtech.easybuy.cart_order.exception.ResourceNotFoundException;
import com.backtech.easybuy.cart_order.repository.CartRepository;
import com.backtech.easybuy.cart_order.repository.OrderRepository;
...
//            return response.getBody();
    ...
    public ProductResponse createOrder(OrderCreateRequest orderCreateRequest) {
        ...
        //check products ids:
        //product information
        String productId = orderCreateRequest.items().get(0).productId();
